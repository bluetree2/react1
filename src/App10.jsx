...
function MyAwesomButton1({ color, children }) {
  return (
    <>
...
function App10() {
  return (
    <>
      ...
      <MyAwesomButton1 color="red">전송</MyAwesomButton1>
      <MyAwesomButton1 color="blue">등록</MyAwesomButton1>
      <MyAwesomButton1 color="yellow">저장</MyAwesomButton1>
