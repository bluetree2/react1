...
function ChileComp12({text}) {
  return (
    <div>
      <ChileComp13 text={text}/>
    </div>
  );
}

function ChileComp11({text}) {
  return (
    <div>
      <ChileComp12 text={text}/>
    </div>
  );
}
...
function MyComp4() {
  ...
  const [list, setList] = useState([]);
  // list를 사용해서 childcomp43을 출력해 보기
